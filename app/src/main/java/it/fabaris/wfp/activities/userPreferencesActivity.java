...
public class userPreferencesActivity extends PreferenceActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        String ip = settings.getString(userPreferencesActivity.KEY_IP, null);
        String port = settings.getString(userPreferencesActivity.KEY_PORT, null);
        String directory = settings.getString(userPreferencesActivity.KEY_DIRECTORY, null);
         ...
         * settings protocol
         */
        protocol = settings.getString(userPreferencesActivity.KEY_PROTOCOL, null);
        ...
        buttonCheckConn.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            public boolean onPreferenceClick(Preference pref) {
                ...
                String httpServer = settings.getString(userPreferencesActivity.KEY_SERVER_URL, getString(R.string.default_server_url));
                String numClient = settings.getString(userPreferencesActivity.KEY_CLIENT_TELEPHONE, getString(R.string.default_client_telephone));

                //SCELTA CONNESSIONE A RICHIESTA
                String onRequest = settings.getString(userPreferencesActivity.KEY_REQUEST_CHOISE, getString(R.string.on_request));
...
//        });
        ...
        OnPreferenceChangeListener listener = new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                if (newValue.toString().equals("1")) {
                    editor.putString(userPreferencesActivity.KEY_PROTOCOL, "http");

                    String serverurl = new String();

                    String ip = (settings.getString(userPreferencesActivity.KEY_IP, getString(R.string.server_IP))).trim();
                    String port = (settings.getString(userPreferencesActivity.KEY_PORT, getString(R.string.server_port))).trim();
                    String directory = (settings.getString(userPreferencesActivity.KEY_DIRECTORY, getString(R.string.server_directory))).trim();
                    ...
                    editor.putString(userPreferencesActivity.KEY_SERVER_URL, serverurl);
                    editor.commit();
                    ...
                    editor.putString(userPreferencesActivity.KEY_PROTOCOL, "https");
                    String serverurl = new String();
                    String ip = (settings.getString(userPreferencesActivity.KEY_IP, getString(R.string.server_IP))).trim();
                    String port = (settings.getString(userPreferencesActivity.KEY_PORT, getString(R.string.server_port))).trim();
                    String directory = (settings.getString(userPreferencesActivity.KEY_DIRECTORY, getString(R.string.server_directory))).trim();
    ...
    private void updateServerIP() {
        ...
        if (isValidUrl(protoc + "://" + ip) & !isIP(ip)) {//if as ip there is an url
            ...
            SharedPreferences.Editor editor = settings.edit();
            editor.putString(userPreferencesActivity.KEY_PORT, "");
            editor.commit();
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case DialogInterface.BUTTON_POSITIVE:
                                 ...
                                 * DELETE THE DB
                                 */
                                userPreferencesActivity.this.deleteDatabase("grasp.db");
                                userPreferencesActivity.this.deleteDatabase("forms.db");
                                //**********************************************
