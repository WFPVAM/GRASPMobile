...
public class XFormAnswerDataParser {
	...
	private static Vector getSelections (String text, QuestionDef q) {
		...
		//Vector choices = DateUtils.split(text, XFormAnswerDataSerializer.DELIMITER, true);  //Commented by MarcoG: space delimiter doesn't allow spinner values with space
		Vector choices = DateUtils.split(text, ";;", true);
