...
{ 
    ...
    public DbAdapterGrasp open() throws SQLException //il database su cui agiamo è leggibile/scrivibile 
    {   
        dbHelper = new DatabaseHelper(context); 
        database = dbHelper.getWritableDatabase(); 
        return this; 
    ...
    { 
        return database.query(DATABASE_CREATE_SUBMITTED_FORM, new String[] {SUBMITTED_FORM_ID_KEY, SUBMITTED_FORM_ID_SUBMITTED_KEY, SUBMITTED_FORM_NOME_FORM, SUBMITTED_FORM_SUBMITTED_DATA, SUBMITTED_FORM_COMPLETED_DATA, SUBMITTED_FORM_BY}, null, null, null, null, null); 
    }
