 ...
 *
 */
public class FormProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        Long nowSaved = Long.valueOf(System.currentTimeMillis());
    ...
    static {
        ...
        sUriMatcher.addURI(FormProviderAPI.AUTHORITY, "forms", FORMS);
        sUriMatcher.addURI(FormProviderAPI.AUTHORITY, "forms/#", FORM_ID);
        sFormsProjectionMap = new HashMap<String, String>();
        sFormsProjectionMap.put(FormsColumns._ID, FormsColumns._ID);
        sFormsProjectionMap.put(FormsColumns.STATUS, FormsColumns.STATUS);
        sFormsProjectionMap.put(FormsColumns.DISPLAY_NAME, FormsColumns.DISPLAY_NAME);
        sFormsProjectionMap.put(FormsColumns.DISPLAY_NAME_INSTANCE, FormsColumns.DISPLAY_NAME_INSTANCE);
        ...
        sFormsProjectionMap.put(FormsColumns.INSTANCE_FILE_PATH, FormsColumns.INSTANCE_FILE_PATH);
