    ...
    private void updateInstanceDatabase(boolean incomplete, boolean canEditAfterCompleted) {
		...
		if(instanceIfExist(mInstanceName)){
		    ...
		    */
			...
			//-----------------------------------------------------
			//ApplicationExt.getDatabaseAdapter().open().insert("SAVED", nome_form_saved+"&"+formid, nome_form_saved, data, author);
			ApplicationExt.getDatabaseAdapter().open().insert("SAVED", nome_form_saved+"&"+formid, mInstanceName, data, author);
			ApplicationExt.getDatabaseAdapter().close();
			//-----------------------------------------------------
			...
			String query = "INSERT INTO forms" +
					...
					"language)" +
					"VALUES" +
					"('saved','"+FormEntryActivity.formName+"','"+mInstanceName+"','','"+formid+"','"+FormEntryActivity.mFormPath+"','','"+autoGeneratedName+"','','"+data+"','','','','','','','"+FormEntryActivity.mInstancePath+"','IT')";
