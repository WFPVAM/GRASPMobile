...
public final class WebUtils {
	...
	public static final List<AuthScope> buildAuthScope(String host){
	...
	public static final void clearAllCredentials(){
		...
		CredentialsProvider credsProvider = (CredentialsProvider) 
				localContext.getAttribute(ClientContext.CREDS_PROVIDER);
		credsProvider.clear();
	}
	public static final boolean hasCredentials(String userEmail, String host){
		...
		List<AuthScope> asList = buildAuthScope(host);
...
//            HttpClient httpclient, String auth) {
    public static DocumentFetchResult getXmlDocument(String urlString, Context localContext, String auth) {
        URI u = null;
        try {
