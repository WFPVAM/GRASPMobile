        ...
        mCaptureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((Activity) getContext())
                    ...
                    Toast.makeText(getContext(), getContext().getString(R.string.activity_not_found, "audio capture"), Toast.LENGTH_SHORT).show();
                }
        ...
        mPlayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((Activity) getContext()).startActivity(i);
                    ...
                    Toast.makeText(getContext(),
                        getContext().getString(R.string.activity_not_found, R.string.play_audio),
                        Toast.LENGTH_SHORT);
                  //TODO manca .show()
                }
